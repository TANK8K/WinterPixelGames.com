...
#define ARROW_CXX_COMPILER_FLAGS "-fvisibility-inlines-hidden -std=c++17 -fmessage-length=0 -march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /root/miniconda3/envs/streamlit/include -fdebug-prefix-map=/croot/arrow-cpp_1707253267958/work=/usr/local/src/conda/arrow-cpp-14.0.2 -fdebug-prefix-map=/root/miniconda3/envs/streamlit=/usr/local/src/conda-prefix -fdiagnostics-color=always"
