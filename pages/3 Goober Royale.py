...
if st.session_state.game == "GooberRoyale" and st.session_state.page == "menu":
    with ph.container():
        ...
        with col1:
            st.link_button('Browser', 'https://gooberroyale.winterpixel.io')
    ...
    with ph.container():
        from pages.GooberRoyale.Statistics.user_info import load_page as GooberRoyale_user_info
        GooberRoyale_user_info()
        back_to_menu()

elif st.session_state.game == "GooberRoyale" and st.session_state.page == "season_leaderboard":
    with ph.container():
        from pages.GooberRoyale.Statistics.season_leaderboard import load_page as GooberRoyale_season_leaderboard
