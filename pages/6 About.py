...
st.markdown('''**:blue-background[WinterPixelGames]** provides useful **Tools & Statistics** of games made by **[Winterpixel Games](https://www.winterpixel.com/)**!
...
st.info(
    'This website is **NOT** affiliated with or endorsed by **Winterpixel Games Inc.** All relevant trademarks belong to their respective owners.',
    icon="ℹ️")
